...
We use Vanilla CSS with design tokens. Before adding hardcoded colors or margins, check `packages/shared/web/css/tokens.css` for the standard CSS variables (`--color-primary`, `--spacing-4`, etc.).
