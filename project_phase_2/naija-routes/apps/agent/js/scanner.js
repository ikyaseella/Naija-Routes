...
function onScanSuccess(decodedText, decodedResult) {
  ...
  if (decodedText.includes('NR-TICKET')) {
    ...
    document.getElementById('statusText').textContent = (window.I18N ? I18N.t('agent.valid_ticket') : 'VALID TICKET');
    ...
    document.getElementById('statusIcon').textContent = '❌';
    document.getElementById('statusText').textContent = (window.I18N ? I18N.t('agent.invalid_ticket') : 'INVALID OR USED');
